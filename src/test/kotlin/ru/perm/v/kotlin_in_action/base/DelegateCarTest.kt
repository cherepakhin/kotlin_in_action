...
class DelegateCarTest {
    ...
    fun delegateBehaviorTest()  {
        ...
        // Функции МОГУТ БЫТЬ вызваны при обращении к методам класса CarDelegateWithExtended
        ...
        // и могут буть вызваны при обращении к CarDelegateWithExtended
