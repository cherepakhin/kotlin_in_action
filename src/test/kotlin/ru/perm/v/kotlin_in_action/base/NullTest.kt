...
//        Вывод: ЗАБИТЬ на NULL. В kotlin все уже настроено, чтобы не запинаться об эту хрень.
//        Всякие проверки на null нужны только в вызовах java кода. (А в библиотеках?)
    }
}